...
class Discussion extends React.Component {
    ...
    postMessage = async () =>{
        ...
        messageData = {
            ...
            "postedBy": 'user', //localStorage.getItem('userType')
            "userId": localStorage.getItem('id'),
            "description":document.getElementById('messageChat').value,
            "fileUrl": ''
          };
    ...
    renderMessagesView(obj,index) {
        ...
        if(obj.postedBy == 'user' && this.state.data.isAnonymous == true) {
            return (
                <div className="col-md-12 col-sm-12 col-xs-12 m-Bottom-30 no-left-padding-div user-mode" key={index}>
        ...
        }else if(obj.postedBy === 'user' && this.state.data.isAnonymous == false) {
            return (
                <div className="col-md-12 col-sm-12 col-xs-12 m-Bottom-30 no-left-padding-div user-mode" key={index}>
                    <div className="col-md-12 col-sm-12 col-xs-12 d-flex flex-column">
                        <div className="row">
            ...
            <SweetAlert
                ...
                <div className="col-md-11 col-sm-11 col-xs-12">
                    ...
                    <form action="javascript:void(0);" id="myForm">
                        <TextArea rows={3} id='messageChat' required={true} placeholder="Write post here…" className="m-Bottom-30" disabled ={disabled ? true : false } />
